...
#ifndef MamdaOrderBookComplexDeltaH
#define MamdaOrderBookComplexDeltaH
...
namespace Wombat
{
    ...
    class MAMDAOPTExpDLL MamdaOrderBookComplexDelta : public MamdaOrderBookBasicDeltaList
...
#endif // MamdaOrderBookComplexDeltaH
