    ...
    (JNIEnv* env, jobject this)
{
    ...
    MAMA_THROW_NULL_PARAMETER_RETURN_VALUE(subscriptionPointer,
    "MamaSubscription.getSubscriptionState(): Null parameter, subcription may have been destroyed.", MAMA_SUBSCRIPTION_UNKNOWN);
...
JNIEXPORT jint JNICALL Java_com_wombat_mama_MamaSubscription_getTheAppDataType (JNIEnv* env, jobject this)
{
    ...
    MAMA_THROW_NULL_PARAMETER_RETURN_VALUE(subscriptionPointer,
    "MamaSubscription.getAppDataType(): Null parameter, subcription may have been destroyed.", 0);
