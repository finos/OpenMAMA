...
static void createPublisher ( )
{
    ...
    mamaDQPublisherManager_create (gDQPubManager,
                                   gPubTransport,
                                   gPubDefaultQueue,
                                   &managerCallback,
                                   gPubSource,
                                   ...
                                   mamaMsg                msg)
{
    ...
    mamaDQPublisherManager_createPublisher (manager,
                                            symbol,
    ...
    mamaPlaybackFileParser_openFile (gSubscriptionList[index].fileParser,
                                     (char *)gFilename);
