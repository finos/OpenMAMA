...
#define MAMA_PRICE_IMPL_HINT_PREC_100000000000      ((mama_price_hints_t)0x0b)
#define MAMA_PRICE_IMPL_HINT_PREC_1000000000000     ((mama_price_hints_t)0x0c)
#define MAMA_PRICE_IMPL_HINT_PREC_10000000000000    ((mama_price_hints_t)0x0d)
#define MAMA_PRICE_IMPL_HINT_PREC_100000000000000   ((mama_price_hints_t)0x0e)
#define MAMA_PRICE_IMPL_HINT_PREC_1000000000000000  ((mama_price_hints_t)0x0f)
...
#define mamaPriceImpl_isDecimal(precision) \
    ((((precision) >= MAMA_PRICE_IMPL_HINT_PREC_10) && \
     ((precision) <= MAMA_PRICE_IMPL_HINT_PREC_1000000000000000)) || \
     ((precision) == MAMA_PRICE_IMPL_HINT_PREC_10000000000000000))
