#ifndef MAMADQSTRATEGYPLUGIN_H_
#define MAMADQSTRATEGYPLUGIN_H_
...
PLUGINExpDLL mama_status
dqstrategyMamaPlugin_publisherPreSendHook(mamaPluginInfo pluginInfo,
